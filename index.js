...
app.get('/stocks/sort/pricing', (req, res) => {
  ...
  let sortStockByPricing = stocks.sort((stock1, stock2) => {
  ...
  res.json(sortStockByPricing);
});

app.get('/stocks/sort/growth', (req, res) => {
  let growth = req.query.growth;
  let sortStockByGrowth = stocks.sort((stock1, stock2) => {
...
app.get('/stocks/filter/exchange', (req, res) => {
  ...
  let filterStocksByExchange = stocks.filter((stock) =>
    filterByExchange(stock, exchange)
  );

  res.json(filterStocksByExchange);
});
...
app.get('/stocks/filter/industry', (req, res) => {
  ...
  let filterStocksByIndustry = stocks.filter((stock) =>
    filterByIndustry(stock, industry)
  );

  res.json(filterStocksByIndustry);
});
